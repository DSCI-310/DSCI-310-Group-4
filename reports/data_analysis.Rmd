...
summary_stat <- read_csv("../results/summary_stats.csv")
...
````{r score_1, echo=FALSE}
score_1 <- read_csv("../results/scores_1.csv")
knitr::kable(score_1)
````
...
````{r score_2, echo=FALSE}
score_1 <- read_csv("../results/scores_2.csv")
knitr::kable(score_2)
````
...
````{r coef, echo=FALSE}
coefs <- read_csv("../results/coefs.csv")
knitr::kable(coefs)
````
...
```{r roc, echo=FALSE, fig.dim = c(8, 6), fig.cap="Figure 9: ROC"}
...
knitr::kable(metrics)
````
```{r confusion_matrix, echo=FALSE, fig.dim = c(8, 6), fig.cap="Figure 10: Confusion matrix"}
